...
<div className="page">
  ...
  <div className="bg-[#dae3f3] py-2 px-3 mb-6 w-full flex-shrink-0">
    <h1 className="text-[14pt] font-bold text-black text-left m-0 p-0">Practical Assessment Task 1</h1>
  </div>
  ...
  <div className="mb-4 break-inside-avoid">
    <table className="w-full border-collapse border border-black text-[9pt]">
      ...
      <tbody>
        ...
        <tr><td colSpan={2} className="border border-black p-2 font-bold text-right bg-gray-200">Task Outcome:</td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><div className="flex flex-col gap-1 items-center justify-center"><div className="flex gap-2 items-center cursor-pointer" onClick={() => !isStudent && setCompRecord({ ...compRecord, 'pa4_outcome': compRecord['pa4_outcome'] === 'Satisfactory' ? '' : 'Satisfactory' })}><div className="w-4 h-4 border border-black rounded-sm flex items-center justify-center bg-white">{compRecord['pa4_outcome'] === 'Satisfactory' && <span className="text-red-600 font-bold text-lg leading-none">✓</span>}</div><span>Satisfactory</span></div></div></td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><div className="flex flex-col gap-1 items-center justify-center"><div className="flex gap-2 items-center cursor-pointer" onClick={() => !isStudent && setCompRecord({ ...compRecord, 'pa4_outcome': compRecord['pa4_outcome'] === 'Not Satisfactory' ? '' : 'Not Satisfactory' })}><div className="w-4 h-4 border border-black rounded-sm flex items-center justify-center bg-white">{compRecord['pa4_outcome'] === 'Not Satisfactory' && <span className="text-red-600 font-bold text-lg leading-none">✓</span>}</div><span>Not Satisfactory</span></div></div></td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><input type="text" className="w-full border-b border-black border-dashed min-h-[20px] bg-transparent text-center focus:outline-none" value={compRecord['pa4_outcome_comments'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa4_outcome_comments': e.target.value })} readOnly={isStudent} placeholder="" /></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Assessor signature</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><div onClick={() => !isStudent && openSigModal('pa4_assessor_sig', 'comp')} className="w-full min-h-[30px] cursor-pointer flex items-center justify-center">{compRecord['pa4_assessor_sig'] ? <img src={compRecord['pa4_assessor_sig']} className="max-h-[30px] max-w-[100px] object-contain inline-block" /> : <span className="text-[10px] text-slate-400 italic no-print">{isStudent ? '' : 'Click to sign'}</span>}</div></td></tr>
        ...
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Date</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><input type="date" className="w-full bg-transparent text-center focus:outline-none" value={compRecord['pa4_date'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa4_date': e.target.value })} readOnly={isStudent} /></td></tr>
      </tbody>
    </table>
  </div>
  <PageFooter n={29} />
  ...
  <div className="mb-4 break-inside-avoid">
    <table className="w-full border-collapse border border-black text-[9pt]">
      ...
      <tbody>
        ...
        <tr><td colSpan={2} className="border border-black p-2 font-bold text-right bg-gray-200">Task Outcome:</td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><div className="flex flex-col gap-1 items-center justify-center"><div className="flex gap-2 items-center cursor-pointer" onClick={() => !isStudent && setCompRecord({ ...compRecord, 'pa6_outcome': compRecord['pa6_outcome'] === 'Satisfactory' ? '' : 'Satisfactory' })}><div className="w-4 h-4 border border-black rounded-sm flex items-center justify-center bg-white">{compRecord['pa6_outcome'] === 'Satisfactory' && <span className="text-red-600 font-bold text-lg leading-none">✓</span>}</div><span>Satisfactory</span></div></div></td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><div className="flex flex-col gap-1 items-center justify-center"><div className="flex gap-2 items-center cursor-pointer" onClick={() => !isStudent && setCompRecord({ ...compRecord, 'pa6_outcome': compRecord['pa6_outcome'] === 'Not Satisfactory' ? '' : 'Not Satisfactory' })}><div className="w-4 h-4 border border-black rounded-sm flex items-center justify-center bg-white">{compRecord['pa6_outcome'] === 'Not Satisfactory' && <span className="text-red-600 font-bold text-lg leading-none">✓</span>}</div><span>Not Satisfactory</span></div></div></td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><input type="text" className="w-full border-b border-black border-dashed min-h-[20px] bg-transparent text-center focus:outline-none" value={compRecord['pa6_outcome_comments'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa6_outcome_comments': e.target.value })} readOnly={isStudent} placeholder="" /></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Assessor signature</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><div onClick={() => !isStudent && openSigModal('pa6_assessor_sig', 'comp')} className="w-full min-h-[30px] cursor-pointer flex items-center justify-center">{compRecord['pa6_assessor_sig'] ? <img src={compRecord['pa6_assessor_sig']} className="max-h-[30px] max-w-[100px] object-contain inline-block" /> : <span className="text-[10px] text-slate-400 italic no-print">{isStudent ? '' : 'Click to sign'}</span>}</div></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Assessor name</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><input type="text" className="w-full bg-transparent text-center focus:outline-none" value={compRecord['pa6_assessor_name'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa6_assessor_name': e.target.value })} readOnly={isStudent} /></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Date</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><input type="date" className="w-full bg-transparent text-center focus:outline-none" value={compRecord['pa6_date'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa6_date': e.target.value })} readOnly={isStudent} /></td></tr>
      </tbody>
    </table>
  </div>
  <PageFooter n={38} />
  ...
  <div className="mb-4 break-inside-avoid">
    <table className="w-full border-collapse border border-black text-[9pt]">
      ...
      <tbody>
        ...
        <tr><td colSpan={2} className="border border-black p-2 font-bold text-right bg-gray-200">Task Outcome:</td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><div className="flex flex-col gap-1 items-center justify-center"><div className="flex gap-2 items-center cursor-pointer" onClick={() => !isStudent && setCompRecord({ ...compRecord, 'pa7_outcome': compRecord['pa7_outcome'] === 'Satisfactory' ? '' : 'Satisfactory' })}><div className="w-4 h-4 border border-black rounded-sm flex items-center justify-center bg-white">{compRecord['pa7_outcome'] === 'Satisfactory' && <span className="text-red-600 font-bold text-lg leading-none">✓</span>}</div><span>Satisfactory</span></div></div></td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><div className="flex flex-col gap-1 items-center justify-center"><div className="flex gap-2 items-center cursor-pointer" onClick={() => !isStudent && setCompRecord({ ...compRecord, 'pa7_outcome': compRecord['pa7_outcome'] === 'Not Satisfactory' ? '' : 'Not Satisfactory' })}><div className="w-4 h-4 border border-black rounded-sm flex items-center justify-center bg-white">{compRecord['pa7_outcome'] === 'Not Satisfactory' && <span className="text-red-600 font-bold text-lg leading-none">✓</span>}</div><span>Not Satisfactory</span></div></div></td><td colSpan={1} className="border border-black p-2 text-center align-middle bg-gray-200"><input type="text" className="w-full border-b border-black border-dashed min-h-[20px] bg-transparent text-center focus:outline-none" value={compRecord['pa7_outcome_comments'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa7_outcome_comments': e.target.value })} readOnly={isStudent} placeholder="" /></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Assessor signature</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><div onClick={() => !isStudent && openSigModal('pa7_assessor_sig', 'comp')} className="w-full min-h-[30px] cursor-pointer flex items-center justify-center">{compRecord['pa7_assessor_sig'] ? <img src={compRecord['pa7_assessor_sig']} className="max-h-[30px] max-w-[100px] object-contain inline-block" /> : <span className="text-[10px] text-slate-400 italic no-print">{isStudent ? '' : 'Click to sign'}</span>}</div></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Assessor name</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><input type="text" className="w-full bg-transparent text-center focus:outline-none" value={compRecord['pa7_assessor_name'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa7_assessor_name': e.target.value })} readOnly={isStudent} /></td></tr>
        <tr><td colSpan={2} className="border border-black p-2 font-bold bg-gray-200">Date</td><td colSpan={3} className="border border-black p-2 text-center align-middle"><input type="date" className="w-full bg-transparent text-center focus:outline-none" value={compRecord['pa7_date'] || ''} onChange={(e) => !isStudent && setCompRecord({ ...compRecord, 'pa7_date': e.target.value })} readOnly={isStudent} /></td></tr>
      </tbody>
    </table>
  </div>
  <PageFooter n={42} />
