...
export const Q5Booklet: React.FC<Q5BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q5Styles = `
      ...
      .q5-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q5-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
