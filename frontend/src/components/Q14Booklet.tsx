...
export const Q14Booklet: React.FC<Q14BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q14Styles = `
      ...
      .q14-booklet-view h2.sub-title {
        font-size: 11pt;
        font-weight: bold;
        text-align: center;
        margin: 2mm 0;
      }
      .q14-booklet-view h3.task-label {
        font-size: 10.5pt;
        font-weight: bold;
        text-align: center;
        margin: 1mm 0 3mm;
      }
      .q14-booklet-view .intro-box {
        background: #f5f5f5;
      ...
      .q14-booklet-view table {
        width: 100%;
        border-collapse: collapse;
        margin-bottom: 4px;
        font-size: 9.5pt;
      }
      .q14-booklet-view table td, .q14-booklet-view table th {
        border: 1px solid #555;
        padding: 3px 6px;
        vertical-align: top;
      }
      .q14-booklet-view table th {
        background: #e8e8e8;
        font-weight: bold;
      }
      .q14-booklet-view .field-label-cell {
        font-weight: bold;
        background: #f0f0f0;
        width: 38%;
        border: 1px solid #555;
      ...
      .q14-booklet-view .field-value-cell {
        border: 1px solid #555;
        padding: 5px 6px;
        min-height: 22px;
      }
      ...
      .q14-booklet-view .inner-header .top-row {
      ...
      .q14-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q14-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
      ...
      <div className="page">
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '6px' }}>
          <tbody>
            ...
            {(assessmentQuestions.adminInfo as any).taskOverviews?.map((task: any, idx: number) => (
              ...
              <>
                ...
                <tr><td style={{ border: '1px solid #555', padding: '3px 6px', fontWeight: 'bold' }}>Assessment Task 4</td><td style={{ border: '1px solid #555', padding: '3px 6px', whiteSpace: 'pre-wrap' }}>{(assessmentQuestions.adminInfo as any).task4Description}</td></tr>
              </>
            )}
          </tbody>
        </table>
