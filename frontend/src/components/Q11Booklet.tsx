...
export const Q11Booklet: React.FC<Q11BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q11Styles = `
      ...
      .q11-booklet-view h2.sub-title {
        font-size: 11pt;
        font-weight: bold;
        text-align: center;
        margin: 2mm 0;
      }
      .q11-booklet-view h3.task-label {
        font-size: 10.5pt;
        font-weight: bold;
        text-align: center;
        margin: 1mm 0 3mm;
      }
      .q11-booklet-view .intro-box {
        background: #f5f5f5;
      ...
      .q11-booklet-view table td, .q11-booklet-view table th {
        border: 1px solid #555;
        padding: 3px 6px;
        vertical-align: top;
      }
      .q11-booklet-view table th {
        background: #e8e8e8;
        font-weight: bold;
      }
      .q11-booklet-view .field-label-cell {
        font-weight: bold;
        background: #f0f0f0;
        width: 38%;
        border: 1px solid #555;
      ...
      .q11-booklet-view .field-value-cell {
        border: 1px solid #555;
        padding: 5px 6px;
        min-height: 22px;
      }
      ...
      .q11-booklet-view .evidence-item { display: flex; align-items: center; gap: 4px; }
      .q11-booklet-view .result-badge {
      ...
      .q11-booklet-view .inner-header {
        margin-bottom: 4mm;
        border-bottom: 2px solid #000;
        padding-bottom: 2mm;
      }
      .q11-booklet-view .inner-header .top-row {
        display: flex; justify-content: space-between; align-items: flex-start;
      }
      .q11-booklet-view .inner-header .title-block { font-weight: bold; font-size: 11.5pt; color: #b00; }
      .q11-booklet-view .underline-bold { text-decoration: underline; font-weight: bold; }
      .q11-booklet-view .checklist-table th { background: #e0e0e0; font-size: 9.5pt; }
      .q11-booklet-view .checklist-table td { padding: 4px 6px; font-size: 9pt; }
      .q11-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q11-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
