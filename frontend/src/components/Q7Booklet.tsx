...
export const Q7Booklet: React.FC<Q7BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q7Styles = `
      ...
      .q7-booklet-view h2.sub-title {
        font-size: 11pt;
        font-weight: bold;
        text-align: center;
        margin: 2mm 0;
      }
      .q7-booklet-view h3.task-label {
        font-size: 10.5pt;
        font-weight: bold;
        text-align: center;
        margin: 1mm 0 3mm;
      }
      .q7-booklet-view .intro-box {
        background: #f5f5f5;
      ...
      .q7-booklet-view table {
        width: 100%;
        border-collapse: collapse;
        margin-bottom: 4px;
        font-size: 9.5pt;
      }
      .q7-booklet-view table td, .q7-booklet-view table th {
        border: 1px solid #555;
        padding: 3px 6px;
        vertical-align: top;
      }
      .q7-booklet-view table th {
        background: #e8e8e8;
        font-weight: bold;
      }
      .q7-booklet-view .field-label-cell {
        font-weight: bold;
        background: #f0f0f0;
        width: 38%;
        border: 1px solid #555;
      ...
      .q7-booklet-view .field-value-cell {
        border: 1px solid #555;
        padding: 5px 6px;
        min-height: 22px;
      }
      ...
      .q7-booklet-view .evidence-item { display: flex; align-items: center; gap: 4px; }
      .q7-booklet-view .result-badge {
      ...
      .q7-booklet-view .inner-header {
        margin-bottom: 4mm;
        border-bottom: 2px solid #000;
        padding-bottom: 2mm;
      }
      .q7-booklet-view .inner-header .top-row {
      ...
      .q7-booklet-view .checklist-table th { background: #e0e0e0; font-size: 9.5pt; }
      .q7-booklet-view .checklist-table td { padding: 4px 6px; font-size: 9pt; }
      .q7-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q7-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
