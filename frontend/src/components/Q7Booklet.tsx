        ...
        <div className="pl-0 mt-2">
          ...
          {q.type === 'multipart_radio' && q.parts?.map((part: any, pIdx: number) => (
            <div key={pIdx} className="mb-3 bg-gray-50 p-2 border border-gray-200">
              <div className="font-bold mb-1 whitespace-pre-wrap text-[9.5pt]">{part.text}</div>
  ...
  return (
    <div className="q7-booklet-view">
      ...
      <div className="page">
        <div className="inner-header">
          <div className="top-row">
            <div className="title-block"><div><span className="underline-bold">Assessment book</span></div><div><span className="underline-bold">{assessmentQuestions.metadata.code} {assessmentQuestions.metadata.course}</span></div></div>
            <img src="/assets/Skilscope.png" alt="Skilscope Logo" style={{ height: '32px', width: 'auto', objectFit: 'contain' }} />
          </div>
        </div>
      ...
      {/* ═══════════════════ PAGE 3 – ADMIN (unit info through specific resources) ═══════════════════ */}
      <div className="page">
        <InnerHeader />
      ...
      {/* ═══════════════════ PAGE 4 – ADMIN (re-assessment through task 1 description) ═══════════════════ */}
      <div className="page">
        <InnerHeader />
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '6px' }}>
          <tbody>
            <tr><td style={{ border: '1px solid #555', padding: '3px 6px', fontWeight: 'bold', width: '30%' }}>Re-assessment</td><td style={{ border: '1px solid #555', padding: '3px 6px', whiteSpace: 'pre-wrap' }}>{admin.reAssessment}</td></tr>
      ...
      {/* ═══════════════════ PAGE 5 – ADMIN (task 2–4, competency decision, reasonable adjustment) ═══════════════════ */}
      <div className="page">
        <InnerHeader />
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '6px' }}>
          <tbody>
            <tr><td style={{ border: '1px solid #555', padding: '3px 6px', fontWeight: 'bold', width: '30%' }}>Assessment Task 2</td><td style={{ border: '1px solid #555', padding: '3px 6px', whiteSpace: 'pre-wrap' }}>{admin.task2Description}</td></tr>
      ...
      <div className="page">
        ...
        <div className="mt-3">{qs.slice(0, 2).map((q: any) => renderQ(q, 'task1'))}</div>
        <PageFooter n={6} />
      </div>
      ...
      <div className="page">
        <InnerHeader />
        <div className="mt-2">{qs.slice(2, 6).map((q: any) => renderQ(q, 'task1'))}</div>
        <PageFooter n={7} />
      </div>
      ...
      <div className="page">
        <InnerHeader />
        <div className="mt-2">{qs.slice(6, 11).map((q: any) => renderQ(q, 'task1'))}</div>
        <PageFooter n={8} />
      </div>
      ...
      <div className="page">
        <InnerHeader />
        <div className="mt-2 mb-4">{qs.slice(11).map((q: any) => renderQ(q, 'task1'))}</div>
      ...
      <div className="page">
        ...
        {task2.sections?.slice(0, 3).map((s: any, i: number) => (
          <div key={i} className="mb-3">{s.title && <h3 className="font-bold mb-1">{s.title}</h3>}<p className="whitespace-pre-wrap text-[9pt]">{s.content}</p></div>
        ))}
        <PageFooter n={10} />
      </div>
      ...
      <div className="page">
        ...
        <table className="w-full border-collapse border-[1.5px] border-black text-[9pt]">
          ...
          <tbody>
            ...
            <tr><td colSpan={3} className="border-[1.5px] border-black bg-[#e0e0e0] font-bold px-3 py-2 whitespace-pre-wrap">{task2.performanceHeader || 'Record of Performance: Did the Candidate:'}</td></tr>
      ...
      <div className="page">
        ...
        {task3.observationSubtitle && <h2 className="sub-title" style={{ whiteSpace: 'pre-wrap', marginBottom: '6px' }}>{task3.observationSubtitle}</h2>}
        {task3.sections?.slice(0, 3).map((s: any, i: number) => (
          <div key={i} className="mb-3">{s.title && <h3 className="font-bold mb-1">{s.title}</h3>}<p className="whitespace-pre-wrap text-[9pt]">{s.content}</p></div>
        ))}
        ...
        <table className="w-full border-collapse border-[1.5px] border-black text-[9pt]">
          ...
          <tbody>
            ...
            <tr><td colSpan={3} className="border-[1.5px] border-black bg-[#e0e0e0] font-bold px-3 py-2 whitespace-pre-wrap">{task3.performanceHeader || 'Record of Performance: Did the Candidate:'}</td></tr>
      ...
      <div className="page">
        ...
        {task4.observationSubtitle && <h2 className="sub-title" style={{ whiteSpace: 'pre-wrap', marginBottom: '6px' }}>{task4.observationSubtitle}</h2>}
        {task4.sections?.slice(0, 3).map((s: any, i: number) => (
          <div key={i} className="mb-3">{s.title && <h3 className="font-bold mb-1">{s.title}</h3>}<p className="whitespace-pre-wrap text-[9pt]">{s.content}</p></div>
        ))}
      ...
      <div className="page">
        <InnerHeader />
        <h2 className="sub-title" style={{ marginBottom: '6px' }}>{task4.checklistTitle} (continued)</h2>
        <table className="w-full border-collapse border-[1.5px] border-black text-[9pt] mb-4">
          <ChkHead />
          <tbody>
            <tr><td colSpan={3} className="border-[1.5px] border-black bg-[#e0e0e0] font-bold px-3 py-2 whitespace-pre-wrap">{task4.performanceHeader || 'Record of Performance: Did the Candidate:'}</td></tr>
