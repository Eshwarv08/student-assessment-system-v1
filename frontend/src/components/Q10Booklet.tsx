...
export const Q10Booklet: React.FC<Q10BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q10Styles = `
      ...
      .q10-booklet-view h2.sub-title {
        font-size: 11pt;
        font-weight: bold;
        text-align: center;
        margin: 2mm 0;
      }
      .q10-booklet-view h3.task-label {
        font-size: 10.5pt;
        font-weight: bold;
        text-align: center;
        margin: 1mm 0 3mm;
      }
      .q10-booklet-view .intro-box {
        background: #f5f5f5;
      ...
      .q10-booklet-view table td, .q10-booklet-view table th {
        border: 1px solid #555;
        padding: 3px 6px;
        vertical-align: top;
      }
      .q10-booklet-view table th {
        background: #e8e8e8;
        font-weight: bold;
      }
      .q10-booklet-view .field-label-cell {
        font-weight: bold;
        background: #f0f0f0;
        width: 38%;
        border: 1px solid #555;
      ...
      .q10-booklet-view .field-value-cell {
        border: 1px solid #555;
        padding: 5px 6px;
        min-height: 22px;
      }
      ...
      .q10-booklet-view .inner-header {
        margin-bottom: 4mm;
        border-bottom: 2px solid #000;
        padding-bottom: 2mm;
      }
      .q10-booklet-view .inner-header .top-row {
        display: flex; justify-content: space-between; align-items: flex-start;
      }
      .q10-booklet-view .inner-header .title-block { font-weight: bold; font-size: 11.5pt; color: #b00; }
      ...
      .q10-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q10-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
