...
export const Q4Booklet: React.FC<Q4BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q4Styles = `
      ...
      .q4-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q4-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
  ...
  return (
    <div className="q4-booklet-view">
        ...
        <div className="inner-header">
          <div className="top-row">
            <div className="title-block">
              ...
              <div><span className="underline-bold">ICTCBL320 Jumper metallic conductor cable in the access network</span></div>
            </div>
      ...
      <div className="page">
        <div className="inner-header">
          <div className="top-row">
            <div><span className="underline-bold">Assessment book</span><br /><span className="underline-bold">ICTCBL320 Jumper metallic conductor cable in the access network</span></div>
            <img src="/assets/Skilscope.png" alt="Skilscope Logo" style={{ height: '32px', width: 'auto', objectFit: 'contain' }} />
          </div>
        </div>
      ...
      <div className="page">
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '6px' }}>
          <tbody>
            ...
            <tr><td style={{ border: '1px solid #555', padding: '3px 6px', fontWeight: 'bold' }}>Assessment Task 4</td><td style={{ border: '1px solid #555', padding: '3px 6px', whiteSpace: 'pre-wrap' }}>{assessmentQuestions.adminInfo.task4Description}</td></tr>
            <tr><td style={{ border: '1px solid #555', padding: '3px 6px', fontWeight: 'bold' }}>Assessment Task 5</td><td style={{ border: '1px solid #555', padding: '3px 6px', whiteSpace: 'pre-wrap' }}>{assessmentQuestions.adminInfo.task5Description}</td></tr>
