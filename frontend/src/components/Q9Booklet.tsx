...
export const Q9Booklet: React.FC<Q9BookletProps> = ({ answers, setAnswers, onSubmit, submitting, studentName, submitDate, isStudent }) => {
  ...
  const q9Styles = `
      ...
      .q9-booklet-view h2.sub-title {
        font-size: 11pt;
        font-weight: bold;
        text-align: center;
        margin: 2mm 0;
      }
      .q9-booklet-view h3.task-label {
        font-size: 10.5pt;
        font-weight: bold;
        text-align: center;
        margin: 1mm 0 3mm;
      }
      .q9-booklet-view .intro-box {
        background: #f5f5f5;
      ...
      .q9-booklet-view table td, .q9-booklet-view table th {
        border: 1px solid #555;
        padding: 3px 6px;
        vertical-align: top;
      }
      .q9-booklet-view table th {
        background: #e8e8e8;
        font-weight: bold;
      }
      .q9-booklet-view .field-label-cell {
        font-weight: bold;
        background: #f0f0f0;
        width: 38%;
        border: 1px solid #555;
      ...
      .q9-booklet-view .field-value-cell {
        border: 1px solid #555;
        padding: 5px 6px;
        min-height: 22px;
      }
      ...
      .q9-booklet-view .inner-header {
        margin-bottom: 4mm;
        border-bottom: 2px solid #000;
        padding-bottom: 2mm;
      }
      .q9-booklet-view .inner-header .top-row {
      ...
      .q9-booklet-view .question-block {
        margin-bottom: 8mm;
      }
      .q9-booklet-view .question-text {
        font-weight: bold;
        margin-bottom: 3mm;
      }
      @media print {
